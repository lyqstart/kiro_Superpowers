# Kiro Superpowers Discipline v1.1.0

把 Superpowers 的核心执行纪律改造成 Kiro 可用的 Power / Steering / Hooks / Custom Subagents。

**v1.1.0 是 Subagent Task Packet + Review Evidence 版本。** 它只在 v1.0.0 基础上增强 subagent 派发上下文、subagent 结果格式、review 证据链和 Git diff evidence；安装、卸载和日常使用方式保持不变。
