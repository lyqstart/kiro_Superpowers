...
for token in [
    'version: "1.0.0"', 'status-banner.md', 'superpowers-router.md', 'worktree-automation.md',
    ...
    'task-completion-contract.md', 'tdd-evidence-contract.md', 'kiro-task-refinement-gate.md', 'v0.8 Stability and Documentation Rules', 'v0.9 TDD Evidence Contract'
]:
...
for token in [
    ...
    'task execution contract', 'task completion contract', 'COMPLETE / NOT COMPLETE / BLOCKED', 'TDD Evidence', 'RED 验证命令', 'GREEN 验证命令', 'Kiro Task Refinement Gate', 'Task Refinement Gate', '任务拆分'
]:
...
for token in [
    ...
    'tdd-evidence-contract.md', 'v0.9.0 TDD Evidence Contract', 'RED/GREEN/REFACTOR', 'kiro-task-refinement-gate.md', 'v1.0.0 Kiro Task Refinement Gate', 'Task Refinement Gate'
]:
...
for rel, tokens in {
    'CHANGELOG.md': ['v1.0.0', 'Kiro Task Refinement Gate', '14-sp-task-refinement-gate'],
    'MIGRATION.md': ['从 v0.9.0 升级到 v1.0.0', 'v1.0.0 只增强 task 执行前的细化检查', '原安装提示不变'],
    'README.md': ['Kiro Superpowers Discipline v1.0.0', 'v1.0.0 是 Kiro Task Refinement Gate 版本'],
}.items():
